...
const [baa, moo, cluck, neigh, oink] = 'sheep cow chicken horse pig'.split(' ')
console.log(baa, moo, cluck, neigh, oink)
// 2. Bolt the horse wandered off, so just give us four animals, and let's name them Bessie, Dolly, Babe, and Little.
const [Babe, Dolly, Little, Bessie] = 'pig sheep chicken cow'.split(' ')
console.log(oink, baa, cluck, moo)
