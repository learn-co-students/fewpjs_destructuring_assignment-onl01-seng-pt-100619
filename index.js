...
// Strings // these exercises are all descrtucturing strings
const farmAnimals = 'cow horse sheep pig chicken'


// 1. Use destructuring to assign appropriate variables based on the sounds animals make.

// its like writing many const variables in one line
...
// use curly brakets for objects
const {name, color, song, job, partner} = muppet

// 8. Use destructuring to assign songs 2 and 4, and Kermit's job and partner
 const {_song_1, song_2, _song_3, song_4} = k_muppet.k_album.the_muppet_movie

 const {_k_name, _k_color, _k_album, k_job, k_partner} = k_muppet
